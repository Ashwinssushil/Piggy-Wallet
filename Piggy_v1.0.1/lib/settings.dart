...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> _toggleAuthentication(bool enabled) async {
    ...
    _showSnackBar(enabled ? 'Setting enabled' : 'Setting disabled');
  }
          ...
          TextButton(
            onPressed: () async {
              if (currentPin.length == 4 && newPin.length == 4) {
                if (await PinService.validatePin(currentPin)) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Version: 1.0.1', style: TextStyle(color: Colors.white)),
            SizedBox(height: 8),
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      SwitchListTile(
                        secondary: Icon(Icons.security, color: Colors.deepPurpleAccent),
