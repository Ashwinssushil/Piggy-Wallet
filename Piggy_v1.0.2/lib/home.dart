...
class HomeConstants {
  ...
  static const double balanceHeight = 220.0;
  static const double quickActionHeight = 160.0;
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  String currency = '₹';
  bool _isImportingData = false; // Add this flag
  ...
  void _exportToPdf() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error exporting PDF. Please try again.'),
